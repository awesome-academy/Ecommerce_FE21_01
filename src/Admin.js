...
export default class admin extends React.Component {
        ...
        return (
            ...
            <>
                <BrowserRouter>
                    ...
                    <div >
                        <img className="bgAdmin" src={require('./img/slide.png')} />
                            ...
                            <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                <div className="sidenav">
                                    ...
                                    <div className="dropdown-container text-center">
                                        <a href="#"><i className="fas fa-arrow-circle-right"></i>Cây chậu treo</a>
                                        <a href="#"><i className="fas fa-arrow-circle-right"></i>Cây có hoa</a>
                                        <a href="#"><i className="fas fa-arrow-circle-right"></i>Cây dây leo</a>
                                        <a href="#"><i className="fas fa-arrow-circle-right"></i>Cây để bàn</a>
                                    </div>
    ...
    display = (url) => {
        let a = '';
        a = url.map((value, index) => {
            return <Route key={index} path={value.path} exact={value.exact} component={value.main} />
        });
        return a;
    }
