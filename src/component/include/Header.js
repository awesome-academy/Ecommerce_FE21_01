            ...
            <Fragment>
                <header>
                    <div className="header--top d-none d-md-block">
                        ...
                        <div className="header--top-right float-right"><Link className="d-inline-block" to="/login"><img src={require('./../../assets/images/Green Shop/signin.png')} alt="signin" /><span>Đăng nhập</span></Link><Link className="d-inline-block" to="/signup"><img src={require('./../../assets/images/Green Shop/signup.png')} alt="signup" /><span>Đăng kí</span></Link></div>
                    </div>
